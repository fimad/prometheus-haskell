...
ghcCollectors = [
    ...
    , statsCollector
            ...
            copied_bytes
    , statsCollector
            "ghc_par_copied_bytes"
            "Sum of copied_bytes across all parallel GCs"
            CounterType
            par_copied_bytes
    , statsCollector
            "ghc_cumulative_par_max_copied_bytes"
    ...
    , statsCollector
            "ghc_gcdetails_sync_elapsed_ns"
            "The time elapsed during synchronisation before GC"
            CounterType
            (gcdetails_sync_elapsed_ns . gc)
    , statsCollector
            "ghc_gcdetails_cpu_ns"
            "The CPU time used during GC itself"
            CounterType
            (gcdetails_cpu_ns . gc)
    , statsCollector
            "ghc_gcdetails_elapsed_ns"
            "The time elapsed during GC itself"
            CounterType
            (gcdetails_elapsed_ns . gc)
  ]
#endif
